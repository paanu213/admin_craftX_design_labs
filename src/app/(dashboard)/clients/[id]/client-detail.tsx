  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <Card>
        ...
        <CardContent>
          {paymentRequiredForKey && !ak ? (
            <div className="flex flex-col items-center justify-center py-6 gap-3 text-center">
              <div className="flex items-start gap-2 text-sm text-amber-600 bg-amber-50 dark:bg-amber-950/30 rounded-xl px-4 py-3 text-left">
                <AlertCircle className="h-4 w-4 shrink-0 mt-0.5" />
                <span>
                  Payment must be approved before generating a subscription key.
                  Send a payment link or record a manual payment above.
                </span>
              </div>
              <RoleGuard permission="generateKey">
                <Button
            ...
            <div className="flex flex-col items-center justify-center py-8 gap-3 text-center">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Generate a key to activate the client&apos;s application.
                </p>
              </div>
              <RoleGuard permission="generateKey">
                <Button
